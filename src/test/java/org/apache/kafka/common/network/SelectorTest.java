...
public class SelectorTest {
    ...
    public void testCantSendWithInProgress() throws Exception {
        ...
        selector.poll(0);
        assertTrue("Channel not isRunning", selector.disconnected().containsKey(node));
    ...
    public void registerFailure() throws Exception {
        ...
        try {
            ...
            assertFalse("Socket not isRunning", socketChannel.isOpen());
        }
        selector.close();
    }
    ...
    public void testCloseOldestConnection() throws Exception {
        ...
        assertTrue("The idle connection should have been isRunning", selector.disconnected().containsKey(id));
